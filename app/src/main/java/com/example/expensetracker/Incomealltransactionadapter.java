...
public class Incomealltransactionadapter extends RecyclerView.Adapter<Incomealltransactionadapter.MyViewHolder> {
    ...
    public Incomealltransactionadapter(Context ctx,ArrayList<Incomealltransactionmodel> incomealltransactionmodelArrayList){
        c=ctx;
    ...
    @NonNull
    @Override
    public Incomealltransactionadapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Incomealltransactionadapter.MyViewHolder holder, int position) {
