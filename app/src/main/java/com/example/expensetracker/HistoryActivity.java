...
public class HistoryActivity extends AppCompatActivity {
    EditText name, email, phoneno, username,income;
    Button update;
    String sid,sname, semail, sphoneno, susername,sincome, sstatus, smessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sincome = user.get("income");
        income.setText(sincome);
       // Toast.makeText(this, sincome, Toast.LENGTH_SHORT).show();
