...
public class loginactivity extends AppCompatActivity {
    ...
    Button login;
    TextView signup;
    String susername,spassword,sstatus,smessage,sid,sName,sEmail,sPhoneno,sGender,sdistrict,sincome,sUsernme,sPassword;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    sincome=jsonObject.getString("income");
                ...
                if ("0".equals(sstatus)) {
                    ...
                    new SessionManager(loginactivity.this).createLoginSession(sid,sName,sEmail,sPhoneno,sGender,sdistrict,sincome,sUsernme,spassword);
